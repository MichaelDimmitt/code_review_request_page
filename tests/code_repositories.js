...
/**
 * Test for /code_repositories
 */
Test('/code_repositories', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test listRepositories get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/code_repositories']['get']['responses']['200']['schema']);
         ...
         */
        t.test('test createRepositories post operation', function (t) {
            Mockgen().requests({
                path: '/code_repositories',
                operation: 'post'
            }, function (err, mock) {
